  ...
  return (
    <section id="products" className="py-24 bg-[#F8FAFC] relative">
      ...
      <div className="absolute top-20 right-[5%] opacity-10 blur-sm">
        <IconSparkle size={120} className="text-yellow-400" />
      </div>
      <div className="absolute bottom-20 left-[5%] opacity-10 blur-sm">
        <IconSparkle size={80} className="text-emerald-400" />
      </div>

      <div className="container-custom relative z-10">
        {/* Section Title */}
        <div className="text-center mb-20 max-w-3xl mx-auto">
          <p className="text-[11px] font-black text-slate-400 uppercase tracking-[4px] mb-4 bg-slate-100 inline-block px-4 py-1.5 rounded-full italic">
            {t.products.label}
          </p>
        ...
        <div className="text-center mt-20">
          <div className="inline-flex items-center gap-4 bg-white px-8 py-4 rounded-[24px] border border-slate-100 shadow-sm">
            ...
            <p className="text-sm text-slate-600 font-bold">
              {t.products.helpText}{' '}
              <a href="https://wa.me/213555123456" className="text-[#0F172A] hover:text-yellow-600 transition-colors underline decoration-yellow-400 decoration-2 underline-offset-4">
